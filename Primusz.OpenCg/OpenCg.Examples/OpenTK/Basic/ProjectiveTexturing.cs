...
namespace OpenCg.Examples.OpenTK.Basic
{
    class ProjectiveTexturing : BaseExample
    {
        ...
        private CgParameter cgParamTextureMatrix;
        private CgParameter cgParamProjectiveMap;
        ...
        protected override void OnLoad()
        {
            ...
            Cg.SetParameter3fv(cgParamKd, kd);
            ...
            cgParamTextureMatrix = Cg.GetNamedParameter(cgVertexProgram, "textureMatrix");
            ...
            cgParamProjectiveMap = Cg.GetNamedParameter(cgFragmentProgram, "projectiveMap");
            CgGL.SetTextureParameter(cgParamProjectiveMap, projectiveMapTexture);
        }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            Cg.SetMatrixParameterfr(cgParamTextureMatrix, textureMatrix);
