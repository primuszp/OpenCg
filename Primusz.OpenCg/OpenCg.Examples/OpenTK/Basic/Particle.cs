...
namespace OpenCg.Examples.OpenTK.Basic
{
    class Particle : BaseExample
    {
        ...
        private CgParameter cgParamGlobalTime;
        private CgParameter cgParamAcceleration;
        ...
        protected override void OnLoad()
        {
            ...
            cgParamGlobalTime = Cg.GetNamedParameter(cgVertexProgram, "globalTime");
            cgParamAcceleration = Cg.GetNamedParameter(cgVertexProgram, "acceleration");
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            Cg.SetParameter1f(cgParamGlobalTime, globalTime);
            Cg.SetParameter4f(cgParamAcceleration, 0, acceleration, 0, 0);
