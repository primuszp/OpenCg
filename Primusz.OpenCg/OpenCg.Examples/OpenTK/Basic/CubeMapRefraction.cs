...
namespace OpenCg.Examples.OpenTK.Basic
{
    class CubeMapRefraction : BaseExample
    {
        ...
        private CgParameter cgParamTransmittance;
        ...
        protected override void OnLoad()
        {
            ...
            cgParamTransmittance = Cg.GetNamedParameter(cgFragmentProgram, "transmittance");
            ...
            Cg.SetParameter1f(cgParamEtaRatio, etaRatio);
            Cg.SetParameter1f(cgParamTransmittance, transmittance);
