...
namespace OpenCg.ObjectModel.Examples.OpenTK
{
    class BaseExample : GameWindow, IExample
    {
        ...
        protected static void DisposeProgram(CgProgramObject program)
        {
            program?.Dispose();
        }

        protected static void UpdateProgramParameters(CgProgramObject program)
        {
            program.UpdateParameters();
        }

        protected static void SetParameter1f(CgParameterObject parameter, float x)
        {
            parameter.Set(x);
        }

        protected static void SetParameter2f(CgParameterObject parameter, float x, float y)
        {
            parameter.Set(x, y);
        }

        protected static void SetParameter3f(CgParameterObject parameter, float x, float y, float z)
        {
            parameter.Set(x, y, z);
        }

        protected static void SetParameter3fv(CgParameterObject parameter, float[] values)
        {
            Cg.SetParameter3fv(parameter.Handle, values);
        }

        protected static void SetParameter4f(CgParameterObject parameter, float x, float y, float z, float w)
        {
            parameter.Set(x, y, z, w);
        }

        protected static void SetMatrixParameterfr(CgParameterObject parameter, float[] matrix)
        {
            parameter.SetMatrix(matrix, CgEnum.RowMajor);
        }

        protected static void SetTextureParameter(CgParameterObject parameter, int textureObject)
        {
            CgGL.SetTextureParameter(parameter.Handle, textureObject);
        }

        protected static void EnableTextureParameter(CgParameterObject parameter)
        {
            CgGL.EnableTextureParameter(parameter.Handle);
        }

        protected static void DisableTextureParameter(CgParameterObject parameter)
        {
            CgGL.DisableTextureParameter(parameter.Handle);
        }

        protected static void SetStateMatrixParameter(CgParameterObject parameter, int matrix, int transform)
        {
            CgGL.SetStateMatrixParameter(parameter.Handle, matrix, transform);
        }
