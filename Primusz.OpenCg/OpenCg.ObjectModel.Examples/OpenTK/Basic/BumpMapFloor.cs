...
{
    [ExampleAttribute("OpenTK/Basic/[22] Bump Map Floor")]
    class BumpMapFloor : BaseExample
    {
        ...
        protected override void OnLoad()
        {
            ...
            cgVertexProgram = context.CreateProgramFromFile( CgEnum.Source,
            ...
            cgFragmentProgram = context.CreateProgramFromFile( CgEnum.Source,
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            SetStateMatrixParameter(cgParamModelViewProj,
