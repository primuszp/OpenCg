...
{
    [ExampleAttribute("OpenTK/Basic/[20] Chromatic Dispersion")]
    class ChromaticDispersion : BaseExample
    {
        ...
        private CgParameterObject cgParamFresnelBias;
        private CgParameterObject cgParamFresnelScale;
        private CgParameterObject cgParamFresnelPower;
        
        private CgParameterObject cgParamEnvironmentMap0;
        private CgParameterObject cgParamEnvironmentMap1;
        private CgParameterObject cgParamEnvironmentMap2;
        private CgParameterObject cgParamEnvironmentMap3;
        ...
        protected override void OnLoad()
        {
            ...
            cgParamFresnelBias = cgVertexProgram.GetNamedParameter("fresnelBias");
            cgParamFresnelScale = cgVertexProgram.GetNamedParameter("fresnelScale");
            cgParamFresnelPower = cgVertexProgram.GetNamedParameter("fresnelPower");

            SetParameter3fv(cgParamEtaRatio, etaRatio);
            SetParameter1f(cgParamFresnelBias, fresnelBias);
            SetParameter1f(cgParamFresnelScale, fresnelScale);
            SetParameter1f(cgParamFresnelPower, fresnelPower);
            ...
            cgParamEnvironmentMap0 = cgFragmentProgram.GetNamedParameter("environmentMap0");
            cgParamEnvironmentMap1 = cgFragmentProgram.GetNamedParameter("environmentMap1");
            cgParamEnvironmentMap2 = cgFragmentProgram.GetNamedParameter("environmentMap2");
            cgParamEnvironmentMap3 = cgFragmentProgram.GetNamedParameter("environmentMap3");

            SetTextureParameter(cgParamEnvironmentMap0, environmentTexture);
            SetTextureParameter(cgParamEnvironmentMap1, environmentTexture);
            SetTextureParameter(cgParamEnvironmentMap2, environmentTexture);
            SetTextureParameter(cgParamEnvironmentMap3, environmentTexture);
        }
