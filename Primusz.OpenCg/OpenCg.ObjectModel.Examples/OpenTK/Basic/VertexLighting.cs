...
namespace OpenCg.ObjectModel.Examples.OpenTK.Basic
{
    ...
    [ExampleAttribute("OpenTK/Basic/[09] Vertex Lighting")]
    ...
    class VertexLighting : BaseExample
    {
        ...
        protected override void OnLoad()
        {
            ...
            cgParamKe = cgVertexProgram.GetNamedParameter("Ke");
            cgParamKa = cgVertexProgram.GetNamedParameter("Ka");
            cgParamKd = cgVertexProgram.GetNamedParameter("Kd");
            cgParamKs = cgVertexProgram.GetNamedParameter("Ks");
