...
namespace OpenCg.ObjectModel.Examples.OpenTK.Basic
{
    ...
    // OpenGL-based lighting attenuation example
    ...
    // Ported from C to C# for the OpenCg examples project.

    #endregion Porting Credits
    [ExampleAttribute("OpenTK/Basic/[12] Light Attenuation")]

    class LightAttenuation : BaseExample
    {
        #region Members

        private const string VertexProgramFileName = "Data\\Shaders\\C5E2v_fragmentLighting.cg";
        private const string FragmentProgramFileName = "Data\\Shaders\\C5E7_attenuateLighting.cg";
        ...
        private readonly float[] globalAmbient = { 0.5f, 0.5f, 0.5f };
        ...
        public LightAttenuation()
            : base("Cg Tutorial 12: Light Attenuation", 400, 400)
        { }
        ...
        protected override void OnLoad()
        {
            ...
            SetParameter1f(cgParamLightConstantAtten, 0.4f);
            SetParameter1f(cgParamLightLinearAtten, 0.1f);
            SetParameter1f(cgParamLightQuadraticAtten, 0.03f);
        }
